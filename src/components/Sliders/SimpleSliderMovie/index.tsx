...
import PosterSimilarMovie from "@/components/PosterSimilarMovie";
...
const SimpleSliderMovie: FC<Props> = ({
  title,
  films,
  isLoading,
  setIsLoading,
...
export default SimpleSliderMovie;
